...
SECRET_KEY = config('SECRET_KEY') #se crea un archivo .env con la variable SECRET_KEY
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'api', #app creada para el api
    'corsheaders', #se agrega para que funcione el cors
]
